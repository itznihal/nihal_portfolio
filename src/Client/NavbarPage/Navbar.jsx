            ...
            <div className="container-fluid">
              ...
              >
                <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                  ...
                  <li className="nav-item">
                    <a className="nav-link scrollto" href="#projectss">
                      Projects
                    </a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link scrollto" href="#certification">
                      Certificates
                    </a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link scrollto" href="#articles">
                      Articles
                    </a>
                  </li>
                  <li className="nav-item">
                  ...
                  <li className="nav-item">
                    <a className="resumeFont scrollto" href="#contact">
                      Contact
                    </a>
                  </li>
                </ul>
